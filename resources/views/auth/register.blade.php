                                    ...
                                    <div class="">
                                        <form method="post" action="{{ Route('auth.store') }}">
                                            ...
                                            <div class="input-field">
                                                ...
                                                <input id="icon_accout"
                                                    {{ $errors->has('name') ? 'class=border-bottom-color' : '' }}
                                                    type="text" name="name" value="{{ old('name') }}" required>
                                                <label for="icon_accout" style="user-select: none">Nome</label>
                                                @if ($errors->has('name'))
                                            ...
                                            <div class="input-field">
                                                ...
                                                <input id="icon_mail"
                                                    {{ $errors->has('email') ? 'class=border-bottom-color' : '' }}
                                                    type="email" name="email" value="{{ old('email') }}" required>
                                                <label for="icon_mail" style="user-select: none">E-mail</label>
                                                @if ($errors->has('email'))
                                                    <span class="helper-text red-text left-align">
                                                        {{ $errors->first('email') }}
                                                    </span>
